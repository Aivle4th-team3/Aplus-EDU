...
class Lecture(models.Model):
    ...
    teacher = models.ForeignKey(User, limit_choices_to={
                                "groups__name": "선생"}, on_delete=models.DO_NOTHING, null=True, blank=True)
...
class Video(models.Model):
    lecture = models.ForeignKey(Lecture, null=True, on_delete=models.CASCADE, related_name="videos")
